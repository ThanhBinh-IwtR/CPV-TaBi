...
import random
img = cv2.imread("IMG/Lenna.jpeg", 1)
...
def func1(img,g):
    ...
    typefont = cv2.FONT_HERSHEY_SIMPLEX
    cv2.putText(adjusted, "g={}".format(g), (10, 30), typefont, 0.8, (0, 0, 255), 3)
    return adjusted
...
def run1():
    global img
    while True:
        print("1:color balance\t2:histogram equalization\t3:median filter\t4:mean filter\t5:Gaussian smoothing\t6:exit")
